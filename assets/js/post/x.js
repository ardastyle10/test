...
* bfwkbcsk, zaQunxlwAp, WKWK, bfwkbcskhjihhifb, ANJINGPEPEK, xD8WPagyhl
*/
...
const posts = [
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL GAROR", author: "ABR", dateLiv: "2025-12-12", typeCar: "GT86", folder: "liv169", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Private", gambar: "img.jpg", judulLiv: "TRIBAL LIMITED", author: "Garage Respect", dateLiv: "2025-12-12", typeCar: "S15", folder: "liv168", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "BMW MODIFIED", author: "QIU", dateLiv: "2025-12-12", typeCar: "Altezza", folder: "liv167", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Honda Civic", author: "ARYANxLivery", dateLiv: "2025-12-12", typeCar: "Altezza", folder: "liv166", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "POLOSAN", author: "Archives CV.AGS", dateLiv: "2025-12-12", typeCar: "R32-4D", folder: "liv165", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "Telegram", dateLiv: "2025-12-08", typeCar: "JZX100MKII", folder: "liv163", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "ITASHA", author: "Garage Respect", dateLiv: "2025-12-08", typeCar: "FC3S", folder: "liv162", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "CIVIC TURBO", author: "CIVIC GANK", dateLiv: "2025-12-11", typeCar: "Altezza", folder: "liv161", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "POLOSAN", author: "RAFF", dateLiv: "2025-12-10", typeCar: "GT86", folder: "liv160", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Onevia", author: "Telegram", dateLiv: "2025-12-07", typeCar: "S13", folder: "liv159", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "ARS", dateLiv: "2025-12-10", typeCar: "S15", folder: "liv158", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "Meihan", dateLiv: "2025-12-04", typeCar: "180SX", folder: "liv157", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Nissan Skyline R30 LIBERTYWALK", author: "frl.rusky", dateLiv: "2025-12-11", typeCar: "R32-2D", folder: "liv156", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "CV.AGS", dateLiv: "2025-12-07", typeCar: "180SX", folder: "liv155", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "CIVIC TYPE R", author: "PSKN SENYAP", dateLiv: "2025-12-09", typeCar: "Altezza", folder: "liv154", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "FINAL BOUT", author: "PSKN SENYAP", dateLiv: "2025-12-09", typeCar: "Altezza", folder: "liv153", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL SPECIAL 695 P", author: "Liww", dateLiv: "2025-12-08", typeCar: "Altezza", folder: "liv152", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "BMW MODIFIED", author: "PSKN SENYAP", dateLiv: "2025-12-08", typeCar: "Altezza", folder: "liv151", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "BMW MODIFIED", author: "CIVIC GANK", dateLiv: "2025-12-08", typeCar: "Altezza", folder: "liv150", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "POLOSAN", author: "789", dateLiv: "2025-12-07", typeCar: "GT86", folder: "liv149", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL DEXTER", author: "CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv148", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img2.jpg", judulLiv: "BEIBER #2", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv147", body: "body2.json", window: "window2.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "BEIBER", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv147", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Base Polosan", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv146", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Netral", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "S15", folder: "liv145", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL BRIO", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv144", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "DANA PELAJAR", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv143", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "SCOOTER", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv142", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL BABOL", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv141", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv140", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "POLOSAN", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv139", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "PENIX", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv138", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv137", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "NMAX", author: "Archives CV.AGS", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "liv136", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TOKOYAMI TOWA", author: "YouTube", dateLiv: "2025-12-07", typeCar: "S14KOUKI", folder: "liv135", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL TENGKORAK", author: "Telegram", dateLiv: "2025-12-05", typeCar: "S14KOUKI", folder: "liv134", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL URAS", author: "ccchxt4", dateLiv: "2025-12-03", typeCar: "S15", folder: "liv133", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL KUMBANG", author: "ABR", dateLiv: "2025-12-06", typeCar: "GT86", folder: "liv132", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL THAILAND", author: "CV.AGS", dateLiv: "2025-12-07", typeCar: "GT86", folder: "liv131", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL BLACKRAT", author: "CV.AGS", dateLiv: "2025-12-07", typeCar: "GT86", folder: "liv130", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL WORKS9", author: "ARYANZ", dateLiv: "2025-12-03", typeCar: "S15", folder: "liv129", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL RBAUTO", author: "ARYANZ", dateLiv: "2025-12-05", typeCar: "GT86", folder: "liv128", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "NZSTYLE BLACK", author: "enzyycreation", dateLiv: "2025-12-05", typeCar: "S15", folder: "liv127", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Honda NSX", author: "Saluran WA", dateLiv: "2025-11-30", typeCar: "180SX", folder: "liv126", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "HONDA CIVIC TYPE R ", author: "Saluran WA", dateLiv: "2025-12-06", typeCar: "Altezza", folder: "liv125", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Private", gambar: "img.jpg", judulLiv: "TRIBAL", author: "CV.AGS", dateLiv: "2025-12-03", typeCar: "Altezza", folder: "liv124", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "ANIME HENTAI", author: "SYIFA23", dateLiv: "2025-12-01", typeCar: "S13", folder: "liv123", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Private", gambar: "img.jpg", judulLiv: "SPEED SONIC", author: "PSKN SENYAP", dateLiv: "2025-12-02", typeCar: "Altezza", folder: "liv122", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "LBWK Mini GT", author: "Saluran WA", dateLiv: "2025-11-30", typeCar: "S15", folder: "liv121", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Mitsubishi Lancer Evo I", author: "frlmods.com", dateLiv: "2025-11-29", typeCar: "Altezza", folder: "liv120", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Mitsubishi Lancer Evo IX", author: "frlmods.com", dateLiv: "2025-11-29", typeCar: "Altezza", folder: "liv119", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Mitsubishi Lancer Evo VIII", author: "CIVIC GANK", dateLiv: "2025-11-27", typeCar: "Altezza", folder: "liv118", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "ANIME", author: "Redly 63.49", dateLiv: "2025-12-02", typeCar: "GT86", folder: "liv117", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "POLOSAN", author: "Redly 63.49", dateLiv: "2025-11-02", typeCar: "GT86", folder: "liv116", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Private", gambar: "img.jpg", judulLiv: "ANIME HENTAI", author: "CV.AGS", dateLiv: "2025-12-02", typeCar: "GT86", folder: "liv115", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Mitsubishi Lancer Evo IV", author: "frlmods.con", dateLiv: "2025-11-30", typeCar: "Altezza", folder: "liv114", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Judul", author: "CV.AGS", dateLiv: "2025-12-01", typeCar: "Altezza", folder: "liv113", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "PSKN SENYAP", dateLiv: "2025-12-01", typeCar: "Altezza", folder: "liv112", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "PETROLIST", author: "YouTube", dateLiv: "2025-12-01", typeCar: "S15", folder: "liv111", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL SHIROKO", author: "Surya ART", dateLiv: "2025-12-01", typeCar: "S15", folder: "liv110", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "ANIME", author: "PSKN SENYAP", dateLiv: "2025-12-01", typeCar: "S15", folder: "liv109", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "LAMBORGHINI", author: "RIZZ", dateLiv: "2025-12-01", typeCar: "S15", folder: "liv108", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Private", gambar: "img.jpg", judulLiv: "TRIBAL", author: "CV.AGS", dateLiv: "2025-11-27", typeCar: "Altezza", folder: "liv107", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Private", gambar: "img.jpg", judulLiv: "TRIBAL", author: "CV.AGS", dateLiv: "2025-11-27", typeCar: "AE86", folder: "liv106", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "BMW F30", author: "PSKN SENYAP", dateLiv: "2025-11-27", typeCar: "Altezza", folder: "liv105", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "AGS", dateLiv: "2025-11-24", typeCar: "Altezza", folder: "liv104", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Porsche 911 991.2 GT3 RS", author: "frl_shadow", dateLiv: "2025-11-24", typeCar: "S15", folder: "liv103", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL SPRINT ARCEUS", author: "T3", dateLiv: "2025-11-24", typeCar: "Altezza", folder: "liv102", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "CIVIC TYPE R", author: "frlmods.com", dateLiv: "2025-11-23", typeCar: "Altezza", folder: "liv101", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Public", gambar: "img.jpg", judulLiv: "BMW F30", author: "ARS", dateLiv: "2025-11-25", typeCar: "Altezza", folder: "liv100", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Mitsubishi Lancer Evo 8", author: "frlmods.com", dateLiv: "2025-11-21", typeCar: "Altezza", folder: "liv95", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL ORACLE", author: "AGS", dateLiv: "2025-11-25", typeCar: "GT86", folder: "liv76", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "BUSTERCUP", author: "SYIFA23", dateLiv: "2025-11-07", typeCar: "S14KOUKI", folder: "liv61", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "AGS", dateLiv: "2025-11-06", typeCar: "BMW E36", folder: "liv49", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "TRIBAL", author: "AGS", dateLiv: "2024-05-10", typeCar: "Altezza", folder: "liv38", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "Dodge Challenger SRT Demon", author: "@frl.shadow", dateLiv: "2025-09-09", typeCar: "R32-4D", folder: "liv10", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Public", gambar: "img.jpg", judulLiv: "BMW MODIFIED", author: "Heyaan", dateLiv: "2025-09-26", typeCar: "Altezza", folder: "liv5", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "750 P SPECIAL LIMIT", author: "IG", dateLiv: "2025-12-07", typeCar: "Altezza", folder: "prem15", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "TRIBAL", author: "CV.AGS", dateLiv: "2025-12-06", typeCar: "Altezza", folder: "prem14", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "TRIBAL NZ STYLE", author: "CV.AGS", dateLiv: "2025-12-06", typeCar: "Altezza", folder: "prem13", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "TRIBAL WORKS9", author: "CV.AGS", dateLiv: "2025-12-06", typeCar: "Altezza", folder: "prem12", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "TRIBAL SPONSOR", author: "CV.AGS", dateLiv: "2025-12-03", typeCar: "Altezza", folder: "prem11", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "CIVIC TRIBAL BLACKRAT", author: "CV.AGS", dateLiv: "2025-12-03", typeCar: "Altezza", folder: "prem09", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "CIVIC FD MUGEN RR", author: "329.frl", dateLiv: "2025-12-01", typeCar: "Altezza", folder: "prem08", body: "body.json", window: "window.json", aspekRasio: "16/9" },
  ...
  { statusL: "Premium", gambar: "img.jpg", judulLiv: "LIVERY #10", author: "CV.AGS", dateLiv: "2025-12-03", typeCar: "Altezza", folder: "ags10", body: "body.json", window: "window.json", aspekRasio: "16/9" },
...
// untuk sistem filter gabungan
let activeStatusFilter = ""; // "public","private","premium","sale","newest","oldest" atau ""
let activeCarFilter = "";    // nilai typeCar dalam lowercase atau ""
// ======================================
...
function generateCarOptions(statusFilter = "") {
  // jika statusFilter kosong -> ambil semua typeCar
  // jika ada -> hanya ambil typeCar dari posts yang cocok statusnya
  carSelect.innerHTML = `<option value="">Semua Type Mobil</option>`;

  const cars = new Set(
    posts
      .filter(p => {
        if (!statusFilter) return true;
        return p.statusL.toLowerCase() === statusFilter.toLowerCase();
      })
      .map(p => p.typeCar)
  );
  ...
  option.value = car.toLowerCase(); // FIX PENTING
  option.textContent = car;
  carSelect.appendChild(option);
});
}

// initial generate (semua)
generateCarOptions();
...
submitToken.addEventListener("click", () => {
  ...
  if (validTokens.includes(userToken)) {
    ...
    // render ulang sesuai filter aktif
    applyFilters();
  } else {
    tokenStatus.textContent = "Token Salah, Coba Lagi!";
    tokenStatus.classList.remove("text-soft-success");
...
function openJSON(index, type) {
  ...
  const safeTitle = getPost.judulLiv
    .replace(/[^a-z0-9\- ]/gi, "")   
    .replace(/ /g, "_");             
...
// Fungsi pusat untuk menerapkan semua filter (status + type car + sorting)
function applyFilters() {
  let filtered = [...posts];

  // Filter berdasarkan status (public/private/premium/sale)
  if (activeStatusFilter !== "") {
    const statusLower = activeStatusFilter.toLowerCase();

    // Jika mode adalah sorting terbaru/terlama
    if (statusLower === "newest") {
      filtered.sort((a, b) => new Date(b.dateLiv) - new Date(a.dateLiv));
    } else if (statusLower === "oldest") {
      filtered.sort((a, b) => new Date(a.dateLiv) - new Date(b.dateLiv));
    } else {
      // status biasa (public/private/premium/sale)
      filtered = filtered.filter(p => p.statusL.toLowerCase() === statusLower);
    }
  }

  // Filter berdasarkan type car (jika ada)
  if (activeCarFilter !== "") {
    filtered = filtered.filter(p => p.typeCar.toLowerCase() === activeCarFilter);
  }

  // Update opsi select type car berdasarkan status saat ini
  // (jika activeStatusFilter kosong -> tampilkan semua type)
  if (activeStatusFilter && (activeStatusFilter.toLowerCase() === "newest" || activeStatusFilter.toLowerCase() === "oldest")) {
    // Untuk mode sort, tetap tampilkan semua type (atau bisa pilih perilaku lain)
    generateCarOptions("");
  } else {
    generateCarOptions(activeStatusFilter);
  }
...
// fungsi-fungsi helper yang men-set activeStatusFilter lalu panggil applyFilters
...
function filterSale() {
  ...
  // reset pilihan type car ketika pindah kategori? biarkan tetap terpilih jika ingin gabungan
  applyFilters();
}
