  ...
  const visitorRef = db.ref('visitor_blogger_aivisual'); // GLOBAL COUNT
  ...
  visitorRef.on('value', (snapshot) => {
    document.getElementById("visitor-blogger-aivisual").innerText = snapshot.val();
    document.getElementById("visitor-blogger-aivisual-img").innerText = snapshot.val();
  });
